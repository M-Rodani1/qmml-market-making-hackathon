...
- **Mohamed Rodani** — prediction models, strategy design, # QMML Market Making Hackathon — AlphaBetaPhi
...
- **Mohamed Rodani** — prediction models, strategy design, rounds 1/3/5/7/9
- **Kieran Cook** — EDA, feature engineering, rounds 2/4/6/8, sizing logic  # QMML Market Making Hackathon — AlphaBetaPhi
...
- **Mohamed Rodani** — prediction models, strategy design, rounds 1/3/5/7/9
- **Kieran Cook** — EDA, feature engineering, rounds 2/4/6/8, sizing logic
...
Python, scikit-learn (LinearRegression, Ridge, GradientBoostingRegressor), pandas, numpy, matplotlib, seaborn, rounds 1/3/5/7/9
